...
CHARM Toolbox is a desktop application for inspecting, processing and comparing images, built for image analysis in cultural heritage settings: museum/library imaging scientists, conservators, and researchers working with standard or multi/hyperspectral image data. This tool aims to give you a fast, focused side-by-side viewing surface without having to write a script every time you want to compare two renderings.
